  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='keywords'
          content='фитнес, спортзал, тренировки, Crossfit, семейный фитнес, Москва'
        />
        <meta property='og:title' content='VOLIMFIT - Фитнес-клуб у дома' />
        <meta
          property='og:description'
          content='Тренировки для всей семьи в Москве! Присоединяйтесь к нашему фитнес-клубу и получите абонемент со скидкой!'
        />
        ...
        <link
          ...
          sizes='300x300'
          href='https://volimfit.ru/logo-shared.png'></link>
        ...
        <main className='mb-auto '>
          ...
          <FadeInSection>
            <div className=' m-4' id='about'>
              <h1 className='text-large font-medium'>Фитнес-клуб для результативных тренировок!</h1>
              <Divider />
          ...
          <FadeInSection>
            <div className='    ' id='section'>
              <div className='  container mx-auto flex w-full flex-col   max-w-7xl'>
                ...
                <h2 className='text-large text-default-600 mb-4'>
                  VOLIMFIT объединяет всю семью — от малышей с 5 лет до взрослых, предлагая
                  персональные и групповые тренировки для каждого возраста и уровня подготовки.
                </h2>
            ...
            <div className='min-h-96   inset-0 w-full h-full     '>
              <div
                ...
                <h4 className='text-2xl font-medium '>Присоединяйся к нам</h4>
