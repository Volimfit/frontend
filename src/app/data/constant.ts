export const trainers = [
  ...
  },
  {
    ...
    education: "Училище олимпийского резерва, Колледж прикладной кинезиологии, Академия физической реабилитации (кинезиотейпирование)",
    experience: "5 лет",
    specializations: [
      "Функциональные тренировки",
      "ЛФК",
  ...
  },
  {
    ...
    "experience": "4 года",
    "specializations": [
        "Групповые и индивидуальные тренировки по джиу-джитсу",
    ],
    "achievements": [
        "КМС по джиу-джитсу",
...
},
{
  ...
  "education": "ООО «ТЕХНОТОН» (научно-исследовательская организация), Диплом о профессиональной переподготовке «Тренер-преподаватель по художественной гимнастике»",
  "experience": "8 лет",
  "specializations": [
